    ...
    <div class="sidebar-menu-top-area">
        <div class="container d-flex align-items-center justify-content-between">
            <div class="sidebar-menu-logo">
                <a href="index.php" class="logo-dark"><img alt="image" class="img-fluid" src="assets/img/logo.png"
                        style="width:50px;"></a>
                <a href="index.php" class="logo-light"><img alt="image" class="img-fluid"
                        src="assets/img/logo-light.svg"></a>
            </div>
                    ...
                    <ul class="main-menu">
                        ...
                        <li>
                            ...
                            <ul class="submenu-list">
                                ...
                                <li><a href="saas-development.php">SAAS Development</a></li>
                            </ul>
                        </li>
                        <li>
                ...
                <div class="sidebar-contact">
                    <div class="getin-touch-area mb-60">
                        ...
                        <ul>
                            <li class="single-contact">
                                ...
                                <div class="contact">
                                    <span>Phone</span>
                                    <h6><a href="tel:+44 7497 506669">+44 7497 506669</a></h6>
                                </div>
                            </li>
                            <li class="single-contact">
                                <div class="icon">
                                ...
                                <div class="contact">
                                    <span>Email Now</span>
                                    <h6><a href="mailto:info@softwaremanagementgroup.com"><span
                                                class="__cf_email__">info@softwaremanagementgroup.com</span></a>
                                    </h6>
                                </div>
                            </li>
                            <li class="single-contact">
                                ...
                                <div class="contact">
                                    <h6>Liverpool, United Kingdom</h6>
                                </div>
                            </li>
                        </ul>
                    </div>
                    <div class="social-link-area">
                        ...
                        <ul class="social-area">
                            ...
                            <li><a href="https://www.pinterest.com/"><i class="bi bi-pinterest"></i> Pinterest</a>
                            </li>
...
if ($currentScript === 'index.php' || $currentScript === '') {
    $headerClass = "header-area style-1";
} else {
    $headerClass = "header-area style-2";
}
?>
